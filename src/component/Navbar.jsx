...
function Navbar() {
  ...
  return (
    <div className="w-full h-20 bg-white shadow-md rounded-b-lg border-b border-gray-200">
      ...
      {expandNavbar && (
        <div ref={drawerRef} className="lg:hidden fixed rounded-b-lg border-b border-l border-gray-200 top-20 right-0 w-1/2 bg-white shadow-md border-t border-gray-200 flex flex-col items-center space-y-4 py-6 z-50">
